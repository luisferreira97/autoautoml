...
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=ExtraTreesRegressor(
        bootstrap=True, max_features=0.45, min_samples_leaf=16, min_samples_split=7, n_estimators=100)),
    StackingEstimator(estimator=RandomForestRegressor(
        bootstrap=True, max_features=0.15000000000000002, min_samples_leaf=12, min_samples_split=9, n_estimators=100)),
