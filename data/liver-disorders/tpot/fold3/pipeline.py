...
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=XGBRegressor(learning_rate=0.001, max_depth=3, min_child_weight=11,
                      n_estimators=100, nthread=1, objective="reg:squarederror", subsample=0.45)),
    MinMaxScaler(),
