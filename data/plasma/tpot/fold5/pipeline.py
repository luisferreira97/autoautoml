...
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=RandomForestRegressor(
        bootstrap=True, max_features=0.25, min_samples_leaf=19, min_samples_split=8, n_estimators=100)),
    ...
    GradientBoostingRegressor(alpha=0.75, learning_rate=0.01, loss="lad", max_depth=5, max_features=0.7500000000000001,
                              min_samples_leaf=3, min_samples_split=19, n_estimators=100, subsample=0.7500000000000001)
)
