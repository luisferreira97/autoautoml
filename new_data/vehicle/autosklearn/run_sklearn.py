...
for x in range(0, 10):
    fold_folder = "/home/lferreira/autoautoml/new_data/vehicle/autosklearn/fold" + str(x+1)
    folds = [fold1, fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold10]
    test_df = folds[x]
    ...
    automl.fit(X_train.copy(), y_train.copy(), metric=autosklearn.metrics.f1_macro)
    ...
    perf["pred_score"] = sklearn.metrics.f1_score(y_test, predictions, average='macro')
