...
for x in range(0, 10):
    ...
    fold_folder = "/home/lferreira/autoautoml/new_data/liver-disorders/h2o-xgboost/fold" + str(x+1)
    folds = [fold1, fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold10]
    test_df = folds[x]
    ...
    aml = H2OAutoML(seed=42, sort_metric = "mae", nfolds=5, include_algos=["XGBoost"], max_runtime_secs = 3600)
