...
for x in range(1, 10):
    fold_folder = "/home/lferreira/autoautoml/new_data/churn/autokeras/fold" + str(x+1)
    folds = [fold1, fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold10]
    test_df = folds[x]
    ...
    perf["start"] = start
    perf["end"] = end
    perf["test_score"] = sklearn.metrics.roc_auc_score(y_test, preds.reshape((len(preds),)))
