...
for x in range(0, 10):
    fold_folder = "/home/lferreira/autoautoml/new_data/cmc/autogluon/fold" + str(x+1)
    folds = [fold1, fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold10]
    test_df = folds[x]
    del folds[x]
    ...
    predictor = task.fit(train_data=train_data, label=label_column, eval_metric="f1_macro", num_bagging_folds=5, output_directory = fold_folder)
