...
fold_folder = "/home/lferreira/autoautoml/new_data/cholesterol/autopytorch/fold" + str(x+1)
folds = [fold1, fold2, fold3, fold4, fold5, fold6, fold7, fold8, fold9, fold10]
test_df = folds[x]
...
perf = autonet.fit(X_train=X_train, Y_train=y_train, validation_split=0.25, early_stopping_patience=3)
